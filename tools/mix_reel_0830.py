...
речи») жёстче пресета, поэтому gain считается от замера. На первой сборке стояло
−22 дБ (запас 10.3 дБ), пользователь попросила ещё тише — сейчас −26 дБ.
...
DUR = 28.933333
MUS_START = 11.5
MUS_GAIN = 0.0501             # −26 дБ, см. docstring
